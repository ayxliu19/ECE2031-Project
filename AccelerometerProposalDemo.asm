; AccelerometerProposalDemo.asm (Assembly)
; This code displays the combined X and Y acceleration values 
; Alex Liu
; ECE2031 L02
; 10/17/2020
...
ORG 0
Start:
	CALL   SetupI2C		; initialize I2C bus and accelerometer
	LOADI 0
	OUT	SqGen
...
Read:
	...
	SHIFT  -4			; divide the value by 16
	;STORE   AccelVal
	;IN      Switches
	;SHIFT   AccelVal
	;OUT    SqGen
	OUT    SqGen
	OUT    LEDs			; display the value in the LEDS
	OUT    HEX0			; display the value in HEX0
	JUMP   Read			; Repeat
